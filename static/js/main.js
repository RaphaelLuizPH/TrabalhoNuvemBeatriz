...
function auladaBia() {
  ...
  document.getElementById(
    "aulatempo"
  ).innerHTML = `Faltam ${horas} horas, ${minutos} minutos e ${segundos} segundos para o fim da aula!`;
  ...
  if (horas > 2.5 && horas > 0) {
    ...
    document.getElementById(
      "aulatempo"
    ).innerHTML = `Faltam ${horas} horas, ${minutos} minutos e ${segundos} segundos para o começo da aula!`;
  }
...
function startTime() {
  ...
  if (h < 10) document.getElementById("horas").innerHTML = "0" + h + ":" + m;
  else document.getElementById("horas").innerHTML = h + ":" + m;
